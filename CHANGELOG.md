...
- Migrated demo and documentation URLs from Render to self-hosted infrastructure (react-consent-shield.686f6c61.dev)
- Updated all documentation references to new domain
